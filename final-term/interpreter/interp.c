...
void interp() {
    ...
    do {
        ...
        switch (i.f) {
            ...
            case SWITCH:
                j = i.a;
                while (code[j].f != SWEND) {
                    if (code[j].f == SWVALUE) if (stack[t] == code[j].a) {
                        p = code[j + 1].a;
                        break;
                    }
                    else j = j + 2;
                    else if (code[j].f == SWDEFAULT) {
                        p = code[j + 1].a;
                        break;
                    }
                    else runtime_error(4, p);
                }
                t++;
                break;
            case SWVALUE:
